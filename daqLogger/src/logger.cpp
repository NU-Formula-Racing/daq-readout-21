...
// LoggerBoard::LoggerBoard(String fileName, String priority, std::vector<std::string> sensors, std::map<std::string, float> sensor_10ms, std::map<std::string, float> sensor_100ms, std::map<std::string, float> sensor_1000ms)
// {
//     fileName = fileName;
//     hp_lp = priority;
//     dataString = "";
...
// void LoggerBoard::sensor100ms(){
//   DateTime now = rtc.now();

//   // loop through list of 100ms_sensors, convert to C++
//   for (auto const& iter : sensor_group_100ms){
//     dataString += "," + std::to_string(iter.second);
//   }
...
// void LoggerBoard::sensor1000ms(){
//   DateTime now = rtc.now();

//   // loop through list of 1000ms_sensors, convert to C++
//   for (auto const& iter : sensor_group_1000ms){
//     dataString += "," + std::to_string(iter.second);
//   }
